package org.scriptable.template;
        ...
        if (vv.length > 1) {
            for (Object v: vv) {
                if (v instanceof Function) {
                    writeOut();
                    org.scriptable.ScriptableRequest.callJsFunction((Function)v, this);
                }
            ...
            if (vv[0] instanceof Function)
                org.scriptable.ScriptableRequest.callJsFunction((Function)vv[0], this);
            else {
